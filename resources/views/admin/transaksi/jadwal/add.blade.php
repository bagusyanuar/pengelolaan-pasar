...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center">
        <h4 class="mb-0">Halaman Tambah Jadwal Piket Pegawai</h4>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#btn-append').on('click', function (e) {
                e.preventDefault();
                AjaxPost('/jadwal/append', {
                    pegawai: $('#pegawai').val()
                }, function () {
                    reload();
                })
            });
            table = DataTableGenerator('#table-data', '/jadwal/data', [
